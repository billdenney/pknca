...
knitr::kable(
  all.combs[,c("event.before", "iv.bolus.before",
               ...
               "after", "Method")],
    row.names=FALSE,
    col.names=c("Event Before", "IV Bolus Before", "Event At", "IV Bolus At", "Event After", "Instant After", "Method Used"))
```
