...
test_that("print.parseFormula", {
  expect_output(print(parseFormula("~a")),
                regexp="A one-sided formula without groups.  ~a")
  expect_output(print(parseFormula("~a|b")),
                regexp="A one-sided formula with groups.  ~a | b")
  expect_output(print(parseFormula("a~b")),
                regexp="A two-sided formula without groups.  a ~ b")
  expect_output(print(parseFormula("a~b|c")),
                regexp="A two-sided formula with groups.  a ~ b | c")
})
